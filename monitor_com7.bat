@echo off
REM Monitor script specifically for COM7
REM Use this to monitor your ESP32-S3 on COM7

echo ESP32 SIP Door Station - Monitor COM7
echo ======================================
...
echo.
echo Connecting to ESP32-S3 on COM7...
echo.
...
REM Connect to COM7 specifically
